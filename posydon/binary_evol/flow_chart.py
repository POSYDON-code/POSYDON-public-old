...
# catch all massless remnants from cosmic
for b in BINARY_STATES_ALL:
    for s in STAR_STATES_ALL:
        for e in BINARY_EVENTS_ALL:
            POSYDON_FLOW_CHART[('Massless remnant', s, b, e)] = 'step_end'
            POSYDON_FLOW_CHART[(s, 'Massless remnant', b, e)] = 'step_end'
