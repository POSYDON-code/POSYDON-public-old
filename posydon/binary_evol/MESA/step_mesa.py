...
# get path to data submodule
PATH_TO_GRID = os.path.join(PATH_TO_POSYDON, 'data/POSYDON_data/')
...
class MesaGridStep:
    ...
    def load_psyTrackInterp(self, grid_name):
        ...
        if self.verbose:
            print("loading psyTrackInterp: {}".format(self.path+grid_name))
        self._psyTrackInterp = psyTrackInterp(self.path+grid_name,
